...
const RouteSelectorFull = ({ vehicle, toggleExpanded, morphs }) => {
	return (
...
const RouteSelectorSmall = ({ toggleExpanded, morphs }) => {
	return (
...
const RouteSelector = ({ isExpanded, toggleExpanded }) => {
	...
	return (
		isExpanded
			? <RouteSelectorFull toggleExpanded={toggleExpanded} morphs={morphs} />
			: <RouteSelectorSmall toggleExpanded={toggleExpanded} morphs={morphs} />
	);
};
